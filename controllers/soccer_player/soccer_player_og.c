...
int main() {
  ...
  while (wb_robot_step(TIME_STEP) != -1) {
    ...
    Above I have added some print stuff and changed nothing else*/
    var1 = robot_get_x('y',2);
    var2 = robot_get_y('y',2);
    var3 =robot_get_orientation('y',2); /* T stands for Team, P stands for Player*/
    printf('x of robot is: %f', var1);
    printf('y of robot is: %f', var2);
    printf('orientation of robot is: %f', var3);
